...
namespace Infras.Services.Jobs
{
    ...
    public class SyncDiaryJob : IAppJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            var daily = await _kurrentDBClient.ReadStreamAsync(Direction.Forwards, streamKey!, StreamPosition.Start, cancellationToken: ct).AggregateAsync(Diary.Init(), (acc, e) => acc.Apply(e.OriginalEvent.Data.ToArray().GetDataFromBytes(e.OriginalEvent.EventType)!), ct);
