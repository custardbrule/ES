...
namespace Infras.Diary.Services.Jobs
{
    ...
    public class SyncDailyDiaryJob : IAppJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            var daily = await _kurrentDBClient.ReadStreamAsync(Direction.Forwards, streamKey!, StreamPosition.Start, cancellationToken: ct).AggregateAsync(Domain.Diary.DiaryRoot.DailyDiary.Init(), (acc, e) => acc.Apply(e.OriginalEvent.Data.ToArray().GetDataFromBytes(e.OriginalEvent.EventType)!), ct);
